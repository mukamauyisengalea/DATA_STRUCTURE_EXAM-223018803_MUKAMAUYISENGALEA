...
public class DatabaseInitializer {
    ...
    private static void createAdminTable(Statement stmt) throws SQLException {
        String sql = "CREATE TABLE IF NOT EXISTS admin (" +
                ...
                // "email VARCHAR(100), " + // REMOVE THIS LINE IF IT EXISTS
                "phone VARCHAR(20), " +
    ...
    private static void createCourseTable(Statement stmt) throws SQLException {
        String sql = "CREATE TABLE IF NOT EXISTS course (" +
                ...
                "instructorID INT, " + // ADD THIS LINE
                "createdAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP, " +
                "updatedAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, " +
    ...
    private static void createInstructorTable(Statement stmt) throws SQLException {
        String sql = "CREATE TABLE IF NOT EXISTS instructor (" +
                ...
                "email VARCHAR(100), " +
                "phone VARCHAR(20), " +
                "username VARCHAR(50) UNIQUE, " + // Changed from NOT NULL to allow null initially
                "password VARCHAR(255), " + // Changed from NOT NULL to allow null initially
                "qualifications TEXT, " +
                "assignedSince DATE, " +
                "courseID INT, " +
                "created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, " +
    ...
    private static void insertDefaultData(Statement stmt) throws SQLException {
    	...
    	try {
    	    stmt.executeUpdate(
    	            "INSERT IGNORE INTO admin (name, username, password) VALUES " + // REMOVED email
