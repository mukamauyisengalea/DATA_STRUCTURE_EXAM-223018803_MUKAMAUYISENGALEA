...
public class InstructorControlPanel extends JFrame {
    ...
    private List<Object[]> getInstructorCoursesFromDB(int instructorID) {
        ...
        courses.add(new Object[]{"CS101", "Introduction to Programming", "Mon/Wed 9:00-10:30", 45});
    ...
    private List<Object[]> getInstructorStudentsFromDB(int instructorID) {
        ...
        // Mock data for demonstration
        students.add(new Object[]{1001, "John Doe", "CS101", "john.doe@edu.com", "Good"});
        students.add(new Object[]{1002, "Jane Smith", "CS101", "jane.smith@edu.com", "Excellent"});
        students.add(new Object[]{1003, "Mike Johnson", "CS201", "mike.johnson@edu.com", "Average"});
        return students;
    }
    ...
    private void createAssignmentsTab() {
     ...
     // Load real assignments from database
        ...
        if (assignments.isEmpty()) {
            model.addRow(new Object[]{"No assignments", "created yet", "Create your first", "assignment using the", "button above", "N/A"});
        }
    ...
    private void createGradesTab() {
     ...
     // Load real grades from database
        ...
        if (grades.isEmpty()) {
            model.addRow(new Object[]{"No grades", "recorded yet", "Add grades using", "the button above", "", "N/A"});
        }
        ...
        model.addRow(new Object[]{"Mike Johnson", "CS201", "Data Structures Quiz", "A-", "Well prepared", "Edit Grade"});
        ...
        statsGrades.add(new Object[]{"Mike Johnson", "CS201", "Data Structures Quiz", "A-", "Well prepared"});
